...
static bool apply_package(
    ...
    // v0.5.0: activate the translation before normal game init completes.
    // This mirrors the compatibility layer used by the main RenPy Tools app.
    ...
    loader_out << "# Generated by RenPy Tools v0.5.0\n";
